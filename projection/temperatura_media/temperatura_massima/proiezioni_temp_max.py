...
df = pd.read_excel('temperature_max.xlsx',  sheet_name='valori_5_anni')
print(df)
...
plt.title('Proiezioni Temperature Massime in Italia dal 2020 al 2039 Scenario 2.6')
plt.grid(True)
plt.xlabel('Anno')
plt.legend()
plt.savefig('1_ProiezioniTemperatureMassime2.6.png')
plt.show()
...
plt.title('Proiezioni Temperature Massime in Italia dal 2020 al 2039 Scenario 8.5')
plt.grid(True)
plt.xlabel('Anno')
plt.legend()
plt.savefig('2_ProiezioniTemperatureMassime8.5.png', dpi = 400)
plt.show()
...
plt.title('Proiezioni Temperature Massime in Italia dal 2020 al 2039 Scenari a confronto')
plt.grid(True)
plt.xlabel('Anno')
plt.legend()
plt.savefig('3_ProiezioniTemperatureMassime2020_2039scenariaconfronto.png', dpi = 400)
plt.show()

#situazione dal 2001 al 2039
df2 = pd.read_excel('temperature_max.xlsx',  sheet_name='2001_2039')
print(df2)
...
plt.xlabel('Anno')
plt.legend()
plt.savefig('4_ProiezioniTemperatureMax2.62001_2039.png', dpi = 400)
plt.show()
...
plt.xlabel('Anno')
plt.legend()
plt.savefig('5_ProiezioniTemperatureMax8.52001_2039.png', dpi = 400)
plt.show()
...
plt.xlabel('Anno')
plt.legend()
plt.savefig('6_ProiezioniTemperatureMax2001_2039scenariaconfronto.png', dpi = 400)
plt.show()
